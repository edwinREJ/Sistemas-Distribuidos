...
public class _GestionPacientesStub extends org.omg.CORBA.portable.ObjectImpl implements sop_corba.GestionPacientes
{
  ...
  public void registrarPaciente (sop_corba.GestionPacientesPackage.pacienteDTO objPacienteo, org.omg.CORBA.BooleanHolder resultado)
  {
            ...
            try {
                ...
                sop_corba.GestionPacientesPackage.pacienteDTOHelper.write ($out, objPacienteo);
                $in = _invoke ($out);
  ...
  public boolean buscarPaciente (int numeroHabitacion, sop_corba.GestionPacientesPackage.pacienteDTOHolder objPacienteResultado)
  {
            ...
            try {
                ...
                objPacienteResultado.value = sop_corba.GestionPacientesPackage.pacienteDTOHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
